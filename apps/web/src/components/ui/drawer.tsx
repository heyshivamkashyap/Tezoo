  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="bg-muted mx-auto mt-4 hidden h-1 w-25 shrink-0 cursor-grab rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block active:cursor-grabbing" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
